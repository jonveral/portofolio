      ...
      <main className="flex flex-1 w-full max-w-4xl flex-col py-12 px-8 sm:px-16 gap-20">
        ...
        <header className="flex flex-col gap-6 mt-12 animate-in fade-in slide-in-from-bottom-4 duration-700 ease-in-out">
          <div className="flex flex-col gap-2">
            <h1 className="text-5xl sm:text-6xl font-extrabold tracking-tight">
              {/* Gradien biru tua ke biru muda di mode terang */}
        ...
        <section id="keahlian" className="flex flex-col gap-6 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div className="flex flex-col gap-3 p-6 rounded-2xl bg-white dark:bg-transparent border border-blue-100 dark:border-transparent shadow-sm dark:shadow-none">
        ...
        <section id="proyek" className="flex flex-col gap-6 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Card 1 */}
            <div className="group relative flex flex-col justify-between gap-4 p-6 rounded-2xl bg-white dark:bg-zinc-950 border border-blue-100 dark:border-zinc-800 hover:border-blue-300 dark:hover:border-zinc-700 hover:shadow-xl hover:shadow-blue-900/5 transition-all">
              <div className="flex flex-col gap-2">
